...
:: ============================================
echo %YELLOW%[1/5] Проверка Registry %REGISTRY_SERVER%:%REGISTRY_PORT%...%RESET%
...
:: ============================================
echo %YELLOW%[2/5] Проверка образа %IMAGE_NAME%:%TAG% в Registry...%RESET%
...
echo %GREEN%[OK] Образ найден в Registry%RESET%
echo.

:: ============================================
:: ЭТАП 3: ОЧИСТКА ЛОКАЛЬНОГО КЭША
:: ============================================
echo %YELLOW%[3/5] Очистка локального кэша...%RESET%

:: Удаляем локальный образ с этим тегом (если есть)
docker rmi %FULL_IMAGE_NAME% 2>nul
docker rmi %IMAGE_NAME%:%TAG% 2>nul
echo %GREEN%[OK] Локальный кэш очищен%RESET%
echo.

:: ============================================
:: ЭТАП 4: ОСТАНОВКА И УДАЛЕНИЕ СТАРОГО КОНТЕЙНЕРА
:: ============================================
echo %YELLOW%[4/5] Остановка и удаление старого контейнера %CONTAINER_NAME%...%RESET%
...
:: ============================================
:: ЭТАП 5: ЗАПУСК НОВОГО КОНТЕЙНЕРА
:: ============================================
echo %YELLOW%[5/5] Запуск контейнера из %FULL_IMAGE_NAME%...%RESET%
