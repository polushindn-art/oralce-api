...
| **Openfire**      | Коммуникационный сервер    | Только wake-up уведомления на ТСД (без гарантий доставки, без статусов, без чата). Основной канал данных — REST API.                                                       | Openfire (XMPP), Smack                                                          |
